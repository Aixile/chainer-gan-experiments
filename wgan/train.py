...
def main():
    ...
    parser.add_argument("--mode", default='gp', help='gp or clip')
    ...
    if args.dis_class != '':
        ...
        if args.mode == 'gp':
            dis = DCGANDiscriminator(in_ch=args.image_channels, use_bn=False, w_init=chainer.initializers.GlorotNormal())
        else:
    ...
    log_keys = ['epoch', 'iteration', 'gen/loss', 'dis/loss_w1', 'dis/loss']
